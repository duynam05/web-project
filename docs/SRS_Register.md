...
Sau khi hoàn tất đăng ký thành công, hệ thống sẽ chuyển hướng về trang đăng nhập và cho phép người dùng đăng nhập bằng tài khoản vừa tạo thành công để truy cập vào trang chủ (Homepage) mà không cần xác thực email/OTP.
