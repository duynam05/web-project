...
import com.duynam.identityservice.dto.request.IntrospectRequest;
import com.duynam.identityservice.dto.request.LogoutRequest;
import com.duynam.identityservice.dto.request.RefreshRequest;
    ...
    private SignedJWT verifyToken(String token, boolean isRefresh) throws JOSEException, ParseException {
        ...
        Date expiryTime = (isRefresh)
                ? new Date(signedJWT.getJWTClaimsSet().getIssueTime()
                           .toInstant().plus(jwtProperties.getRefreshableDuration(), ChronoUnit.SECONDS).toEpochMilli())
